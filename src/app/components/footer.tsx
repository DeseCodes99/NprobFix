      ...
      <div className="social flex max-md:flex-col max-md:items-start max-md:pl-6 max-md:w-2/4 h-full justify-evenly items-center pb-4   text-white">
        <ul className="max-md:pb-6">
          ...
          <li className=" underline">
            <a href="https://www.facebook.com/mmmmmmwyx" target="_blank" className="pr-2">
              Facebook
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/dejanlatinoski/?next=%2F"  target="_blank" className="pr-2 underline">
              Instagram
            </a>
          </li>
          <li>
